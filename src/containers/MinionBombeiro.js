  ...
  function direcionaCompra() {
    return (
        ...
        <div class="container">
          <div class="row">
            <div class="col-5">
              <img src="Minion-Bombeiro.png"  class="img-thumbnail"/>
            </div>
            <div class="col">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            ...
                            <p class="text-left">Um divertido minion real. O pequeno Rei das miniaturas colecionáveis. Diversão para as crianças, adquira agora mesmo o seu colecionável!!</p>
